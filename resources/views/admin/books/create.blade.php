...
@section('content')
  <h1 class="text-xl font-semibold mb-4">إضافة كتاب</h1>

  <form method="POST" action="{{ route('admin.books.store') }}" enctype="multipart/form-data" class="bg-white p-4 rounded shadow">
    @csrf
    @include('admin.books._form', ['book'=>$book,'categories'=>$categories,'publishers'=>$publishers,'authors'=>$authors])
    <div class="mt-4 flex gap-2">
      <button class="px-4 py-2 rounded bg-indigo-600 text-white">حفظ</button>
