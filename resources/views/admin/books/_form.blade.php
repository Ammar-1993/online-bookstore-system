...
<div class="grid md:grid-cols-2 gap-4">
  ...
  <div>
    <label class="block mb-1">الـ Slug</label>
    <input name="slug" class="w-full rounded border-gray-300" value="{{ old('slug', $book->slug) }}">
  </div>
  <div>
  ...
  <div>
    ...
    <input type="number" step="0.01" name="price" class="w-full rounded border-gray-300" value="{{ old('price', $book->price) }}" required>
  </div>
  <div>
    <label class="block mb-1">العملة</label>
    <input name="currency" class="w-full rounded border-gray-300" value="{{ old('currency', $book->currency ?? 'USD') }}" required>
  </div>
  <div>
    <label class="block mb-1">المخزون</label>
    <input type="number" name="stock_qty" class="w-full rounded border-gray-300" value="{{ old('stock_qty', $book->stock_qty) }}" required>
  </div>
  <div>
  ...
  <div>
    <label class="block mb-1">الناشر</label>
  ...
  <div class="md:col-span-2">
    <label class="block mb-1">المؤلفون</label>
  ...
  <div class="md:col-span-2">
    ...
    <textarea name="description" rows="5" class="w-full rounded border-gray-300">{{ old('description', $book->description) }}</textarea>
  </div>
  <div>
  ...
  <div>
    <label class="block mb-1">تاريخ النشر</label>
  ...
  <div class="md:col-span-2">
    <label class="block mb-1">غلاف الكتاب</label>
